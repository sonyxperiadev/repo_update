...
pushd $PWD/bionic
git fetch https://android.googlesource.com/platform/bionic refs/changes/50/234150/1 && git cherry-pick FETCH_HEAD
git fetch https://android.googlesource.com/platform/bionic refs/changes/53/236953/1 && git cherry-pick FETCH_HEAD
git fetch https://android.googlesource.com/platform/bionic refs/changes/90/497890/1 && git cherry-pick FETCH_HEAD
git fetch https://android.googlesource.com/platform/bionic refs/changes/01/503201/1 && git cherry-pick FETCH_HEAD
popd
...
pushd $PWD/hardware/qcom/keymaster
